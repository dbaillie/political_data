...
| HM Treasury CRA segments | **2020-21 → 2024-25** in current file | ITL1 (older on GOV.UK back to ~1999) |
| HM Treasury PESA | **2020-21 → 2025-26** in current file | UK (functional series from 1999-00) |
...
data/raw/
  ...
  cra2025_db.xlsx             # CRA segment-level spend
  pesa_ch1.xlsx               # UK TME reconciliation
